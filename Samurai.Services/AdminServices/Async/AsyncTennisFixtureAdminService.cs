...
{
  public class AsyncTennisFixtureAdminService : AsyncFixtureAdminService, IAsyncTennisFixtureAdminService
  {
    protected readonly IAsyncTennisFixtureStrategy fixtureStrategy;

    public AsyncTennisFixtureAdminService(IFixtureRepository fixtureRepository,
