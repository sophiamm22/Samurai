...
namespace Samurai.Services.AdminServices.Async
{
  ...
  {
    protected readonly IAsyncFootballFixtureAdminService footballFixtureService;
    protected readonly IAsyncFootballPredictionAdminService footballPredictionService;
    protected readonly IAsyncFootballOddsAdminService footballOddsService;

    public AsyncFootballFacadeAdminService(IAsyncFootballFixtureAdminService footballFixtureService,
      IAsyncFootballPredictionAdminService footballPredictionService, IAsyncFootballOddsAdminService footballOddsService)
    {
    ...
    private async Task<Dictionary<string, FootballCouponViewModel>> UpdateDaysOdds(DateTime fixtureDate)
    {
