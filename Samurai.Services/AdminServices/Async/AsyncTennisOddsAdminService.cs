...
{
  public class AsyncTennisOddsAdminService : AsyncOddsAdminService, IAsyncTennisOddsAdminService
  {
    public AsyncTennisOddsAdminService(IFixtureRepository fixtureRepository, IBookmakerRepository bookmakerRepository,
