...
{
  public abstract class AsyncFixtureAdminService : IAsyncFixtureAdminService
  {
    protected readonly IFixtureRepository fixtureRepository;
    protected readonly IStoredProceduresRepository storedProcRepository;

    public AsyncFixtureAdminService(IFixtureRepository fixtureRepository,
  ...
  public class AsyncFootballFixtureAdminService : AsyncFixtureAdminService, IAsyncFootballFixtureAdminService
  {
    protected readonly IAsyncFootballFixtureStrategy fixtureStrategy;

    public AsyncFootballFixtureAdminService(IFixtureRepository fixtureRepository,
