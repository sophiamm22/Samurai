...
{
  public class AsyncTennisPredictionAdminService : AsyncPredictionAdminService, IAsyncTennisPredictionAdminService
  {
    public AsyncTennisPredictionAdminService(IAsyncPredictionStrategyProvider predictionProvider,
