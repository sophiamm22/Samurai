...
{
  public abstract class AsyncPredictionAdminService : IAsyncPredictionAdminService
  {
    ...
    public AsyncPredictionAdminService(IAsyncPredictionStrategyProvider predictionProvider,
  ...
  public class AsyncFootballPredictionAdminService : AsyncPredictionAdminService, IAsyncFootballPredictionAdminService
  {

    public AsyncFootballPredictionAdminService(IAsyncPredictionStrategyProvider predictionProvider,
      IPredictionRepository predictionRepository, IFixtureRepository fixtureRepository, IStoredProceduresRepository storedProcRepository)
